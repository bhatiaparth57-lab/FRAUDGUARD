...
export const LAYERS = [
  {
    ...
    desc: 'Sanctioned vs released vs expenditure, invoices, payment patterns.',
    detect: ['Overbilling', 'Unusual spending', 'Suspicious transactions'],
    status: 'Analyzing',
    confidence: 94,
  ...
  },
  {
    ...
    desc: 'AI/OCR over invoices, work orders, completion certificates, bills.',
    detect: ['Duplicate documents', 'Inconsistent values', 'Missing documentation'],
    status: 'Risk detected',
    confidence: 98,
    signal: { analyzed: 32720, risk: 91, evidence: 127 },
  },
  {
    id: 'L3',
  ...
  {
    id: 'L4',
    title: 'Geospatial / Asset Verification',
    desc: 'Satellite imagery, GPS, project sites, geo-tagged photos.',
    detect: ['Missing assets', 'Incorrect locations', 'Suspicious sites'],
    status: 'Risk detected',
    confidence: 91,
  ...
  {
    id: 'L5',
    title: 'Temporal & Cross-Project',
    desc: 'Timelines, spending patterns, neighbouring and historical projects.',
    detect: ['Recurring anomalies', 'Unusual timing', 'Systemic inefficiency'],
    status: 'Monitoring',
    confidence: 86,
    signal: { analyzed: 12482, risk: 62, evidence: 57 },
  },
];
